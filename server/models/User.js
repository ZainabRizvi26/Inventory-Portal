...
const schema = new mongoose.Schema({
  ...
  phone: String, cnic: String, dob: Date, department: String, designation: String, location: { type: String, enum: ['islamabad', 'karachi'], required: true }, role: { type: String, enum: ['user', 'admin'], default: 'user' }, isSuperAdmin: { type: Boolean, default: false }, lastSeen: Date
}, { timestamps: true });
